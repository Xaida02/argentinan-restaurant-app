    ...
    <section className="relative mt-[5px] flex flex-col items-center justify-center h-[100%] w-full">
      ...
      <div className="w-[500px] duration-500 cart-box md:w-[900px] shadow-2xl p-4 mt-[40px] min-h-[685px] rounded-lg bg-cyan-50">
        ...
        {!uniqueCartItems.length && (
          <img
            className="duration-1000 m-auto"
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-8 w-full">
                ...
                <img
                  src={image}
                  className="w-[80px] h-[80px] md:w-[130px] md:h-[130px] object-cover shadow-lg rounded"
                  alt=""
                />
                {/* Item name and desc */}
                <div className="flex flex-col justify-center p-4 md:p-0 items-start w-[260px]">
